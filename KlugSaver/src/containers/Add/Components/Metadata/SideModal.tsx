...
const SideModalBase = ({
  ...
  return (
    <KSModal open={open} close={close} title="Change Expense Side">
      <View style={styles(theme).root}>
        <View style={styles(theme).buttonGroup}>
          <TouchableHighlight
            style={[
              styles(theme).button,
              styles(theme).buttonLeft,
              isDebit && styles(theme).selectedView,
            ]}
            ...
            <View style={styles(theme).textContainer}>
              ...
              <Text
                style={[
                  styles(theme).text,
                  isDebit && styles(theme).selectedText,
                ]}>
                Expense
              </Text>
            </View>
          ...
          <TouchableHighlight
            style={[
              styles(theme).button,
              styles(theme).buttonRight,
              isCredit && styles(theme).selectedView,
            ]}
            ...
            <View style={styles(theme).textContainer}>
              ...
              <Text
                style={[
                  styles(theme).text,
                  isCredit && styles(theme).selectedText,
                ]}>
                Income
              </Text>
            </View>
